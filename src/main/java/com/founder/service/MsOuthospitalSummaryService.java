 ...
 * @time:14:16
 */
public interface MsOuthospitalSummaryService extends BaseService<MsOuthospitalSummary> {
    /**
     ...
     */
    @Override
    ArrayList<MsOuthospitalSummary> selectAllByUploadTime(String startTime, String endTime);
     ...
     */
    @Override
    ArrayList<MsOuthospitalSummary> selectByEhrAndPersonId(String ehrId, String personId);
}

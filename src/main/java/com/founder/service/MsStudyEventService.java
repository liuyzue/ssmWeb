 ...
 * @time:14:12
 */
public interface MsStudyEventService extends BaseService<MsStudyEvent> {
    /**
     ...
     */
    @Override
    ArrayList<MsStudyEvent> selectAllByUploadTime(String startTime, String endTime);
     ...
     */
    @Override
    ArrayList<MsStudyEvent> selectByEhrAndPersonId(String ehrId, String personId);
}

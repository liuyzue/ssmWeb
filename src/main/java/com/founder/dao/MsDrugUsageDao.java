...
public interface MsDrugUsageDao extends BaseDao<MsDrugUsage> {
     ...
     */
    @Override
    ArrayList<MsDrugUsage> selectAllByUploadTime(@Param("startTime") String startTime, @Param("endTime") String endTime);
     ...
     */
    @Override
    ArrayList<MsDrugUsage> selectByEhrAndPersonId(@Param("ehr_id") String ehrId, @Param("person_id") String personId);
}

...
public class MsDoctorAdvice extends BaseEntity{
  ...
  private java.sql.Date fillTime;
  ...
  public java.sql.Date getNurEDt() {
    return nurEDt;
  }

  public void setNurEDt(java.sql.Date nurEDt) {
    this.nurEDt = nurEDt;
  }
  ...
  public java.sql.Date getFillTime() {
    return fillTime;
  }

  public void setFillTime(java.sql.Date fillTime) {

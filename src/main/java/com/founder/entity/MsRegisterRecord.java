...
public class MsRegisterRecord extends BaseEntity{
  ...
  private String indPay;
  private String visitStatus;
  private String recIdcard;
  private java.sql.Date recDt;
  ...
  public void setRegiFee(String regiFee) {
    this.regiFee = regiFee;
  }


  public String getIndPay() {
    return indPay;
  }

  public void setIndPay(String indPay) {
    this.indPay = indPay;
  }
  ...
  public java.sql.Date getRecDt() {
    return recDt;
  }

  public void setRecDt(java.sql.Date recDt) {
    this.recDt = recDt;
  }
